 ...
 <table class="table table-bordered" style="width: 600px;">
 	...
 	<tr>
 		...
 		<td>
 			...
 			<h2>입 고 : <span id="ipgoday"></span></h2>
 		</td>
 	</tr>
 	<tr>
      ...
      <div class="modal-content">
        ...
        <!-- 수정폼 -->
        	...
        	<form action="#" id="ufrm" class="form-inline">
        		<input type="hidden" name="unum" id="unum" value="<%=num%>">
		...
		<tr>
			<th bgcolor="pink" style="width: 1oopx;"> 상품사진</th>
			<td>
			<select id="uphoto" name="uphoto" class="form-control">
			
			<script>
			var data=["라운드티","블랙원피스","화이프원피스",
		...
		<tr>
			<th bgcolor="pink" style="width: 100px;"> 색 상 </th>
			<td>
				<input type="color" id="ucolor" name="ucolor"
				class="form-control" value="#ffcccc"
				style="width:80px;">
		</tr>
				<tr>
			<th bgcolor="pink" style="width: 100px;"> 단 가 </th>
			<td>
				...
				<tr>
			<th bgcolor="pink" style="width: 100px;"> 수 량 </th>
			<td>
				...
				<tr>
			<th bgcolor="pink" style="width: 100px;"> 입고 </th>
			<td>
		...
		<tr>
			...
			data-dismiss="modal">DB수정</button>
			</td>
		</tr>
	</table>
</form>
